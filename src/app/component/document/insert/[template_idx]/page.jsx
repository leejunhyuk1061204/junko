...
export default function DocumentInsertPage() {
    ...
    useEffect(() => {
        ...
        const fetchTemplate = async () => {
            try {
                const {data} = await axios.get('http://192.168.0.122/template/detail',
                    {params: {template_idx}});
    ...
    const handleSearch = async () => {
        ...
        try {
            const {data} = await axios.get('http://192.168.0.122/user/search',
    ...
    const handleInsert = async () => {
        ...
        try {
            const {data} = await axios.post('http://192.168.0.122/document/insert', formData);
