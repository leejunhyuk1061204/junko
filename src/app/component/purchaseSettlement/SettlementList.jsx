...
export default function SettlementList() {
    ...
    const fetchList = async (pageNum = 1) => {
        try {
            const res = await axios.get('http://192.168.0.122:8080/settlementList', {
                params: {
    ...
    const handleDelete = async () => {
        ...
        try {
            const res = await axios.delete(`http://192.168.0.122:8080/settlementDel/${selectedData.settlement_idx}`, {
