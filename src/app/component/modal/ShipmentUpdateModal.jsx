...
const ShipmentUpdateModal = ({open,onClose,shipment,getShipmentList}) => {
    ...
    const getShipmentProductList = async() => {
        const {data} = await axios.get(`http://192.168.0.122/shipmentProduct/list/${shipment.shipment_idx}`);
    ...
    const getShipmentProductStockList = async() => {
        const {data} = await axios.post('http://192.168.0.122/shipmentProductStockList',{
    ...
    const insertStock = async() => {
        ...
        openModal({
            ...
            onConfirm: async() => {
                ...
                setTimeout(async ()=>{
                    try {
                        const {data} = await axios.post('http://192.168.0.122/shipment/update', {
