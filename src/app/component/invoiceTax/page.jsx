...
export default function InvoiceListPage() {
    ...
    const fetchData = async () => {
        ...
        const res = await fetch(`http://192.168.0.122:8080/invoice/list?${new URLSearchParams(params)}`)
    ...
    const handleStatusChange = async (invoice_idx, newStatus) => {
        try {
            const res = await axios.put(`http://192.168.0.122:8080/invoice/status/${invoice_idx}`, {
                status: newStatus
            })
