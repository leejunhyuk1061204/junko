...
export default function VoucherListPage() {
    ...
    const isAllChecked = list.length > 0 && checkedItems.length === list.length
    ...
    const handleAllCheck = (e) => {
        if (e.target.checked) {
            setCheckedItems(list.map((item) => item.entry_idx))
        } else {
            setCheckedItems([])
        }
    }
        ...
        <div className="productPage wrap page-background">
            ...
            <div className="product-list-back">
                ...
                <table className="product-list margin-bottom-10">
                    ...
                    {list.map((item) => (
                        <tr key={item.entry_idx}>
                            ...
                            <td><Link href={`./voucher/${item.entry_idx}`}>{item.entry_idx}</Link></td>
                ...
                <div className="product-pagination flex justify-content-center gap_5 margin-bottom-20">
                    <Pagination total={total} page={page} size={size} setPage={setPage} />
                </div>
